...
"Shaping": ["Line a 23 cm (9 inch) loaf pan with parchment paper, leaving an overhang (to cover the cake later on)", "Optional: Line the bottom of the pan with three biscuits. These biscuits will be on top once you invert the cake", "Pour about a third of the mixture into the pan and gently press with the back of a spoon to fill any gaps. If you press too hard you’ll crush the biscuits placed at the bottom of the pan. Pour the remaining mixture in two more additions. Tip: Don’t pour all the mixture at once or you’ll end up with an uneven surface", "Cover with the parchment paper (overhang)"]} 
